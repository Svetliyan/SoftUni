...
import org._08_json_productshop.data.repositories.ProductRepository;
...
import org._08_json_productshop.service.dtos.ProductSeedDto;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductInRangeDto> getAllProductsInRange(BigDecimal from, BigDecimal to) {
        return this.productRepository.findAllByPriceBetweenAndAndBuyerIsNullOrderByPrice(from, to)
                .stream()
                .map(p -> {
