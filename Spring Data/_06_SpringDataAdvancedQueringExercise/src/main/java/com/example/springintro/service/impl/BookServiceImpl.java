...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllByEditionType(EditionType type, int copies) {
    ...
    @Override
    public List<Book> findAllBooksWithPriceOutsideOf(int lowerBound, int higherBound) {
        return bookRepository.findAllByPriceLessThanOrPriceGreaterThan(
                BigDecimal.valueOf(lowerBound),
                BigDecimal.valueOf(higherBound)
        );
    }

    @Override
    public List<String> findAllBooksNotPublishedIn(int year) {
    ...
    @Override
    public List<Book> findAllBooksPublishedBefore(LocalDate date) {
        return bookRepository.findAllByReleaseDateBefore(date);
    }

    @Override
    public List<String> FindAllBooksContaining(String contains) {
        return bookRepository.findAllByTitleContains(contains)
                .stream()
                .map(author -> author.getTitle())
                .toList();
    }
    ...
    @Override
    public int findTitleCountLongerThat(int length) {
